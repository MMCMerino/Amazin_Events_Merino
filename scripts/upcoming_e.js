...
async function traerDatos(){
   try{
     ...
     console.log(datos);
     let eventosQueVienen = cargaDeTarjetasUpcoming(datos.events, datos.currentDate);
     console.log("eventos que vienen",eventosQueVienen);
     cargaDeCheckboxs(datos.events);
 
     function superFiltro(){
       let primerFiltro = filtrarPorTexto(eventosQueVienen,entrada.value);
...
function cargaDeTarjetasUpcoming(array1 ,array2){
